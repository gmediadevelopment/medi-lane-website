      ...
      <div className="container container--narrow">
        ...
        <section className="legal-section">
          ...
          <p>
            ...
            es sich z.B. um Daten handeln, die Sie in ein Kontaktformular eingeben oder über unser 
            Wechselprofil-Formular angeben.
          </p>
          <p>
        ...
        <section className="legal-section">
          ...
          <h3>Wechselprofil (Pflegekräfte-Funnel)</h3>
          <p>
            Wenn Sie über unsere Plattform ein Wechselprofil erstellen, werden die von Ihnen 
            angegebenen Daten (Qualifikation, Wünsche, Prioritäten, Wechselgründe, Kontaktdaten) 
            gespeichert und zur Vermittlung passender Arbeitgeber verwendet.
          </p>
          <p>
            Ihre Daten werden ausschließlich anonymisiert an potenzielle Arbeitgeber weitergegeben. 
            Eine Weitergabe Ihrer Kontaktdaten erfolgt nur nach Ihrer ausdrücklichen Zustimmung.
          </p>
          <p>
        ...
        <section className="legal-section">
          ...
          <p>
            Mit Hilfe von Google Ads Conversion-Tracking können wir erkennen, wie viele Nutzer 
            auf unsere Anzeigen geklickt und welche Aktionen sie auf unserer Website durchgeführt 
            haben. Die dabei erhobenen Informationen werden auf Servern von Google gespeichert.
          </p>
          <p>
        ...
        <section className="legal-section">
          ...
          <p>
            Zur Ausübung Ihrer Rechte wenden Sie sich bitte an: info@medi-lane.de
          </p>
        </section>
